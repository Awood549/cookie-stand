...
function Stores(minCust, maxCust, actualCust, avgCookies, list, cookieTotal, cookiesPerHour, cookieLocationTotal) {
	...
	this.cookieTotal = [];
	this.list = list;
	this.cookieLocationTotal = cookieLocationTotal
	this.render = function () {
		for (var i = 0; i < storeHours.length; i++) {
			...
			this.cookieLocationTotal = this.cookiesPerHour + this.cookieLocationTotal;
...
// thEl.textContent = this.cookieLocationTotal;
// TreeWalker.appendChild(thEl);
